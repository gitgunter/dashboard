...
export const Exam = ({ questions, onClose, config }) => {
  ...
  const handleAnswerChange = (e) => {
    if (answerLocked) {
      return;
    } else if (config.isRealTimeValidation && userAnswers[currentQuestion]) {
    ...
    if (config.isRealTimeValidation) {
      setAnswerLocked(true);
    }
  ...
  const examMutation = useMutation(createExam, {
  ...
  const handleExamData = async () => {
    ...
    examMutation.mutate(examDataObj);
    return examDataObj;
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          alignItems: config.isTimerControllers ? 'flex-start' : 'center',
        }}
      >
        ...
        <ExamTimer
          ...
          showControls={config.isTimerControllers}
      ...
      >
        ...
        <div className={css.examAnswerWrapper}>
          <Answer
            ...
            isCorrect={
              config.isRealTimeValidation &&
              questions[currentQuestion].correctAnswer === answerA.letter
            }
            validation={config.isRealTimeValidation}
          />
          <Answer
            id={answerB.letter}
            ...
            isCorrect={
              config.isRealTimeValidation &&
              questions[currentQuestion].correctAnswer === answerB.letter
            }
            validation={config.isRealTimeValidation}
          />
          <Answer
            ...
            isCorrect={
              config.isRealTimeValidation &&
              questions[currentQuestion].correctAnswer === answerC.letter
            }
            validation={config.isRealTimeValidation}
          />
        </div>
