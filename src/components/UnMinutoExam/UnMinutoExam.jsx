...
import css from './UnMinutoExam.module.css';

export const UnMinutoExam = ({ questions, onClose, config }) => {
  ...
  return (
    ...
    >
      ...
      >
        <p className={css.question}>{questions[currentQuestion].question}</p>
